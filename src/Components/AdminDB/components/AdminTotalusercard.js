...
const AdminTotalusercard = (props) => {
  ...
  return (
    <div>
        {searchsolo.length === 0 ? 
        <div style={{fontSize: '1rem'}}>No Data</div>:
        <a className='stylenone' style={{fontSize: '1rem'}} href={`/product/${searchsolo.producttype}/${searchsolo.id1}`}>{searchsolo.producttitle}</a>}
